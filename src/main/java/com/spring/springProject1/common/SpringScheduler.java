...
//		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
//		String strToday = sdf.format(today);
//		System.out.println("1분에 한번식 메세지 출력.. : " + strToday);
//	}
//	
...
//		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
//		String strToday = sdf.format(today);
//		System.out.println("17시 8분에 메세지 출력.. : " + strToday);
//	}

	@Scheduled(cron = "0 29 17 * * *") // crom = 초 분 시 일 월 요일 - 기본값 '*'
	public void scheduleRun4() throws MessagingException {
		Date today = new Date();
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		String strToday = sdf.format(today);
		System.out.println("17시 29분에 광고 메일 전송.. : " + strToday);

		String email = "gy990213@naver.com";
...
//		FileSystemResource file = new FileSystemResource("C:\\Users\\gy990\\OneDrive\\GYP\\Spring\\springProject\\springframework\\works\\JspringProject\\src\\main\\webapp\\resources\\images");
